# laughing-succotash
A simple peer to peer chatting software built in python that uses Diffie-Helman key exchange and AES encryption. It has text to speech and a chat history feature that saves the time stamp of when a message is sent. 
